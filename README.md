<img width="144" height="144" alt="ollamaportablelogo" src="https://github.com/user-attachments/assets/d174d3d0-24d0-42f1-a7c8-b103f2ff7aab" /> <br/>
# Ollama Portable
...
- **Zero footprint** – nothing is written to your system, no traces left behind after use.
...
- **Start chatting with Gemma 4 immediately** - Click the **New Session** button at the top left of the page to begin chatting with the Gemma 4 LLM.

- **Add new models** - Click the **Settings** button at the bottom left of the page. Enter the name of the model you want to download in the **Pull Model** field, then click the download button next to it. If you're not sure which model to use, click the **Ollama Library** link to view the full list of available Ollama models.

- **Save your sessions and settings** - Click the **Settings** button at the bottom left of the page, then export your preferences or sessions. Copy the generated JSON file to:  
  `[your drive:]\ollama-portable\webui\build\settings` so it will automatically loaded the next time you launch the Ollama Portable server
